    ...
    def do_pass(self, data, it=0):
        ...
        with torch.cuda.amp.autocast(enabled=self.para['amp']):
            ...
            if self.single_object:
                ...
                prev_logits, prev_mask, prev_boundary = self.STCN('segment',
                ...
                this_logits, this_mask, this_boundary = self.STCN('segment',
                ...
                out['boundary_1'] = prev_boundary
                out['boundary_2'] = this_boundary
            else:
                sec_Ms = data['sec_gt']
