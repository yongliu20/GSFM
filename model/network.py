...
class STCN(nn.Module):
    ...
    def segment(self, qk16, qv16, qf8, qf4, mk16, mv16, selector=None): 
        ...
        if self.single_object:
            ...
            logits_0, boundary_0 = self.decoder(mr_0, qf8, qf4)
            logits_1, boundary_1 = self.decoder(mr_1, qf8, qf4)
            logits = torch.cat([logits_0, logits_1], dim=1)
            boundary = torch.cat([boundary_0, boundary_1], dim=1)
